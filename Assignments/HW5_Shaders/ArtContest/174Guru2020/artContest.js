 ...
 */
class ArtContestShader extends ShaderProgram {
    ...
    loadShader() {
        ...
        let artContestShader = getShaderProgramAsync(gl, "artContest");
        let shaderObj = this;
        artContestShader.then(function(shader) {
    ...
    setupMenu() {
        ...
        this.polynomial = "0.5z^3+4z^4+0.3z^3-1";
