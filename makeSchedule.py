...
FIRSTDAY = datetime.date(2022, 8, 31)
...
Holidays = {datetime.date(2022, 10, 18):"Fall Break", datetime.date(2022, 11, 24):"Thanksgiving", datetime.date(2022, 11, 26):"Thanksgiving"}
